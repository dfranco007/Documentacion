...
Mientras no se diga lo contrario, todas las ejecuciones se realizarán en la misma máquina y los tiempos de todas las tablas que aparezcan serán la media de cinco ejecuciones.
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|}
		\hline
		{\bf Número de thread} & Serie  & 2      & 4     & 8     & 16     & 32     & 48     \\ \hline
		{\bf Tiempo}           & 16,522 & 11,630 & 7,797 & 9,377 & 14,371 & 27,663 & 31,371 \\ \hline
	\end{tabular}	
	\caption{Tiempos de ejecución obtenidos en la primera implementación paralela}
\end{table}
...
Se sospecha que la sección crítica está siendo el <<cuello de botella>> en esta implementación ya que esta se hace prácticamente siempre, devido a que el contorno suele tender a expandirse, y puede que repetida varias veces por cada punto, al realizarse por cada nuevo vecino. 
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|}
		\hline
		{\bf Número de thread} & Serie  & 2      & 4     & 8     & 16    & 32    & 48    \\ \hline
		{\bf Tiempo}           & 16,513 & 10,741 & 6,575 & 5,420 & 3,678 & 6,021 & 6,787 \\ \hline
	\end{tabular}
	\caption{Tiempos de ejecución de la segunda implementación}
\end{table}
...
\begin{enumerate}
	\item Compartición falsa en la memoria caché.
\end{enumerate}
