...
\end{enumerate}
 ...
 \begin{figure}[]
 	\captionsetup{justification=centering}
 	\centering
 	\includegraphics[width=.9\textwidth]{./imagenes/switchLevelSet}
 ...
 \begin{table}[]
 	...
 	\begin{tabular}{|l|}
 		...
 		\quad \quad \quad \quad \ \ no, se vuelve al paso 2. \\
 		\hline
 	\end{tabular}
...
\subsection{Gestión del riesgos}
