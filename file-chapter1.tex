...
Se ha decidido probrar 3 tipos de imágenes diferentes, con varios tamaños de estas, varios tamaños de las mallas de \textit{locks} y varios \textit{threads}. En la figura \ref{tiposImagenes} se puede obsevar los tres tipos de imágenes diferentes que se utilizarán en la realización de dichas pruebas.
...
La primera imágen a probar será la imágen \ref{buena1} 
