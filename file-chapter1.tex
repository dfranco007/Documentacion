...
Teniendo en cuenta lo presentado en la introducción de este capítulo sobre la función $\phi$ esta tarea es realmente sencilla. Dado que las islas tendrán un valor negativo y el fondo uno positivo, únicamente habrá que contar los valores negativos que haya en la matriz. Así pues, se ha paralelizado esta tarea con una reducción\protect\footnotemark como se presenta en el código implementado mostrado a continuación. 
