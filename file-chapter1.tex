...
\begin{figure}[H]
	...
	\caption*{Se definen dos listas de vecindad en esta cuadrícula, $L_{in}$ y $L_{out}$. En la imagen se puede ver que el movimiento de la curva C se puede conseguir moviendo un punto de una lista a otra.}	
	\label{aproxLevelSet}
\end{figure}
